...
<div class="menu">
    Kategori: <a href="{{ sprintf("blog/category/%s.html", $item->category->category_slug) }}" title="Umum">{{ $item->category->category_name }}</a>
    <br />
    ...
    <br />
    <br />
    [Dibaca: <span>{{ $item->read_count }}</span>] [Komentar: <a href="{{ $item->slug }}" title="Comments Test">1</a>]<br />
</div>    
@empty
<div class="status">
    Tidak ada article
